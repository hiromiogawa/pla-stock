...
| skill / command | 作業の型 | project orchestrator 5 (commands) + atomic 16 (skills、dispatch reference 含む) + subagent 4。frontmatter は Claude Code 公式形式 (description / argument-hint) のみ、自己参照的な metadata は #232 で除去 | 俯瞰図は #229 drawio で別途 |
