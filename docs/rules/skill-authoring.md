...
- 設計経緯: ADR-0018 (SSoT 境界規約、orchestration only 原則)、ADR-0022 (claude-handbooks plugin 切り出し)、#227 (orchestrator → 本物 slash 化)、#188 (project-bootstrap subagent 化)、#232 (frontmatter metadata 完全削除)
