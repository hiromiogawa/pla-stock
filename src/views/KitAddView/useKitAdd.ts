...
import { addKitEvent, type PurchaseEventInput } from '~/features/kit-stock-add'
 ...
 * - 購入記録: addKitEvent({ data: { delta: +1, reason: 'purchase' } }) → kit_stock.count += 1
 ...
 */
export function useKitAdd(): UseKitAddReturn {
